...
class TestHBNBCommand_help(unittest.TestCase):
    ...
    def test_help_quit(self):
        message_h = "Quit command to exit the program."
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help quit"))
            self.assertEqual(message_h, output.getvalue().strip())

    def test_help_create(self):
        message_h = ("Usage: create <class>\n        "
    ...
    def test_help_EOF(self):
        message_h = "EOF signal to exit the program."
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help EOF"))
            self.assertEqual(message_h, output.getvalue().strip())

    def test_help_show(self):
        message_h = ("Usage: show <class> <id> or <class>.show(<id>)\n        "
    ...
    def test_help_destroy(self):
        message_h = ("Usage: destroy <class> <id> or <class>.destroy(<id>)\n        "
    ...
    def test_help_all(self):
        message_h = ("Usage: all or all <class> or <class>.all()\n        "
    ...
    def test_help_count(self):
        message_h = ("Usage: count <class> or <class>.count()\n        "
    ...
    def test_help_update(self):
        message_h = ("Usage: update <class> <id> <attribute_name> <attribute_value> or"
    ...
    def test_help(self):
        message_h = ("Documented commands (type help <topic>):\n"
             "========================================\n"
...
class TestHBNBCommand_create(unittest.TestCase):
    ...
    def tearDown(self):
        try:
            os.remove("file.json.json")
        except IOError:
            pass
        try:
            os.rename("tmp", "file.json.json")
        except IOError:
            pass
...
class TestHBNBCommand_show(unittest.TestCase):
    ...
    def test_show_no_instance_found_space_notation(self):
        correct = "** oohho sorry no instance found **"
        with patch("sys.stdout", new=StringIO()) as output:
